            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Telah Selesai</h1>
                        ...
                        <!-- <div class="row">
                            ...
                            <?php 
                                ...
                                // $sql = "SELECT * FROM detail_booking ORDER BY id ASC LIMIT 2";
                                // $sql = "SELECT * FROM detail_booking WHERE id <= (select max(id) from detail_booking) AND statusB != 'N' ";
                                $sql = "SELECT * FROM detail_booking WHERE statusB = 'Available'";
                                        ...
                                        <div class="col12">
                                            <div class="table-responsive">
                                                <table width="100%">
                                                    ...
                                                    <tbody>
                                                           <?php
                                                                echo "<tr><td> <span class='jelas'>". $row["id"] . "</span></td><td><span class='jelas'>" . $row["id_pengguna"] . "</span></td><td><span class='jelas'>" . $row["id"] . "</span></td><td><span class='jelas'>" . $row["plat"] . "</span></td><td><span class='jelas'>" . $row["kedatangan"] . "</span><td></tr>";
                                                                // . "</span></td><td><span class='jelas'>" . $row["lantai"]
                                                           ?> 
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
                                        <!-- <div class='col3 kanan'>
                                            <a href='check-in.php'><button type='button' class='btn btn-primary'>Detail</button></a>+
                                        </div> -->
                                    </div>
                                </div>
                                        
                            <?php
                                        // echo "<tr><td> <span class='jelas'>". $row["id"] . "</span></td><td><span class='jelas'>" . $row["lantai"] . "</span></td><td><span class='jelas'>" . $row["id"] . "</span></td><td><span class='jelas'>" . $row["plat"] . "</span></td><td><span class='jelas'>" . $row["kedatangan"] . "</span><td></tr>";    
                                    }                                   
                                } else {
                                    // echo "0 result"; 
                            ?>
                                        ...
                                        <div class="col12">
                                            <div class="table-responsive">
                                                <table width="100%">
                                                    ...
                                                    <tbody>
                                                           <?php
                                                                echo "<tr><td> <span class='jelas'>". "Tidak Ada data" . "</span></td><td><span class='jelas'>" . "Tidak Ada data" . "</span></td><td><span class='jelas'>" . "Tidak Ada data" . "</span></td><td><span class='jelas'>" . "Tidak Ada data" . "</span></td><td><span class='jelas'>" . "Tidak Ada data" . "</span><td></tr>";
                                                           ?> 
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            ?>
                                                    ...
                                                    sss -->
                                                        <!-- <tr> -->
                                                            ...
                                                            <!-- <td><span class="jelas">D</span></td>
                                                            <td><span class="jelas">05</span></td>
                                                            <td><span class="jelas">BK 123 AA</span></td>
                                                            <td><span class="jelas">30/11/2022 12:30</span></td> -->
                                                        <!-- </tr> -->
                                        ...
                                        <!-- <div class="row">
                                            Lantai&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;<span class="jelas">D</span>
                                        </div>
                                        <div class="row">
                                            <div class="col9 kiri">
                                                Nomor Parkir&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;<span class="jelas">05</span>
                                            </div>
                                            <div class="col3 kanan">
                                        ...
                                        <div class="row">
                                            Plat Kendaraan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;<span class="jelas">BK 123 AA</span>
                                        </div>
                                        <div class="row">
                                            <label for="wkt">Waktu Kedatangan&nbsp;: &nbsp;&nbsp;<span class="jelas">30/11/2022 12:30</span></label>
                                        </div>
                                        </div>
                                        <div class="row">
                                            <div class="col4">
