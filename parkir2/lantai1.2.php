                                            ...
                                            <div class="bg-white shadow-lg rounded p-5">
                                                <!-- <div class="btn-group-toggle" data-toggle="buttons"> -->
                                                    <div class="row d-flex justify-content-center">
                                                        <!-- A1-A5 -->
                                                        <input type="checkbox" name="john2">
                                                        <button name="btnJohn" type="submit" >AAA</button>
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            ?>
                                                                                    <!-- <div class="btn btn-primary mt-5 pt-3 px-4">
                                                                                        ...
                                                                                        <input type="radio" name="nama_slot" value="<?php // $row["nama_slot"]; ?>" id="<?php // $row["nama_slot"]; ?>" style="display:none;">
                                                                                        <label for="<?php //$row["nama_slot"]; ?>">Book</label>
                                                                                    ...
                                                                                    <input type="checkbox" class="mt-5 rounded-3 py-3 px-4" name="nama_slot[]" value="<?= $row["nama_slot"]; ?>" id="<?php echo $row["nama_slot"]; ?>">
                                                                                    <label for="<?= $row['nama_slot'];?>">Book</label>
                                                                                    <!-- <input type="hidden" name="id" value="<?php // $row["id_slot"]; ?>" > -->
                                                                                    <!-- <button class="btn btn-primary mt-5 rounded-3 py-3 px-4" value="<?php // $row["nama_slot"]; ?>" id="<?php // $row["nama_slot"]; ?>" >Book</button> -->
                                                                            <?php else :?>
                                                                                    <!-- <button class="btn btn-primary disabled mt-5 rounded-3 p-3 px-4" disabled>Book</button>-->
                                                                                    <input type="checkbox" class="mt-5 rounded-3 py-3 px-4" name="nama_slot" value="<?= $row["nama_slot"]; ?>" id="<?php // $row["nama_slot"]; ?>" disabled>
                                                                                    <label for="<?= $row['nama_slot'];?>" class="disabled">Book</label>
                                                                            <?php endif; ?>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        ?>  
                                                                    <div class="card text-white bg-<?= $color; ?> text-center mx-4" style="height: 250px; width: 170px;">
                                                                        <div class="card-body">
                                                                            ...
                                                                            ?>
                                                                                    <!-- <div class="btn btn-primary mt-5 pt-3 px-4">
                                                                                        <input type="hidden" name="id"value="<?php //echo $row["id_slot"]; ?>">
                                                                                        <input type="radio" name="nama_slot" value="<?php // $row["nama_slot"]; ?>" id="<?php // $row["nama_slot"]; ?>" style="display:none;" >
                                                                                        <label for="<?php //$row["nama_slot"]; ?>">Book</label>

                                                                                        
                                                                                        <button type="submit" name="nama" value="<?php //echo $row["nama_slot"]; ?>" id="<?php //echo $row["nama_slot"]; ?>" class="btn btn-primary mt-5 pt-3 py-3 px-4 active" class="warna-tombol">Book</button>
                                                                                    </div> -->
                                                                                    <!-- <input type="checkbox" name="nama_slot" value="<?php// echo $row["nama_slot"]; ?>"> -->
